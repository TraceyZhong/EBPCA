...
def make_iter_plot(prior, PC, iters, plot_seps = [-0.5, 0.5], bp_colors = ['#de2d26', '#3182bd']):
    ...
    plt.title('%s, %s PC, alignment across iterations' % (prior, PC))
    plt.savefig('figures/univariate/Figure1/%s_%sPC_iterations_boxplots.png' % (prior, PC))
    plt.close()
